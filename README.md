...
> Статус: реализованы Python-каркас и воспроизводимый генератор синтетических
> данных. База, SQL-витрины и анализ ещё не созданы.
...
Генератор и его контрактные тесты созданы. Следующий этап — контроль качества
данных; он начинается только по отдельному разрешению.
